...
export const RELEASE_NOTES: ReleaseNotesEntry[] = [
  {
    ...
    headline: "What's new",
    summary:
      "Get notified for Offers and catalog decisions, report or block collectors, and delete your account in Settings.",
    highlights: [
      {
        title: "Push for Offers and catalog",
        icon: "sparkles",
        body: "Optional **push notifications** when someone sends an **Offer** (trade or for sale) or when a catalog submission is decided. Control **Push: Offers** and **Push: Catalog** in Settings.",
      },
      {
        title: "Report or block",
        icon: "shield",
        body: "On another collector’s profile, use **⋯** to **report** spam, scams, or harassment, or **block** them. Blocked collectors cannot start new Offers with you.",
      },
      {
        title: "Delete your account",
        icon: "circle-user",
        body: "Settings → **Delete Account** removes your sign-in and vault photos in the app. Approved catalog entries may stay in the community database without your name.",
      },
      {
        title: "Sale offers in Activity",
        icon: "arrow-left-right",
        body: "New and answered **sale offers** now show in **Activity** (and can push) the same way trades do — not only in Hunt → Offers.",
      },
    ],
    changelog: [
      { kind: "feature", text: "**Push notifications** for Offers (trade + for sale) and catalog submission decisions." },
      { kind: "improvement", text: "**Push: Offers** and **Push: Catalog** masters in Settings, plus a one-time permission prompt." },
      { kind: "feature", text: "**Report collector** from a collector profile (spam, harassment, scam, inappropriate, other)." },
      { kind: "feature", text: "**Block collector** — no new Offers; open unshipped threads cancel; Unblock from profile or Settings." },
      { kind: "feature", text: "**Delete Account** in Settings (two confirms) — in-app, not a website form." },
      { kind: "improvement", text: "Sale offers write **Activity** rows so Alerts and push match Hunt Offers." },
      { kind: "improvement", text: "Approved catalog submissions can **auto-link** to the vault copy they were submitted from." },
      { kind: "improvement", text: "Smoother **import preview** handoff and more consistent **cutout** tile sizing." },
      { kind: "fix", text: "Settings footer shows the real app version (same as What’s new)." },
    ],
  },
  {
    version: "1.0.4",
