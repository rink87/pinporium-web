...
const WhatsNewCard: React.FC<Props> = ({ entry, isLatest }) => {
  ...
  return (
    <article
      ...
      className="w-full max-w-[440px] md:max-w-[520px] mx-auto overflow-hidden rounded-deco border border-gold-deco/30 bg-cream shadow-[0_12px_40px_-8px_rgba(44,51,69,0.18)]"
    >
      <BrandStripe />
