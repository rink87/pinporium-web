...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative w-full overflow-x-hidden pb-0 pt-28 md:pt-36 px-5 deco-sunburst"
    >
      ...
      <div className="relative z-10 mx-auto flex w-full min-w-0 max-w-3xl flex-col items-center text-center">
        ...
        <h1 className="w-full max-w-2xl text-4xl md:text-5xl md:leading-tight font-display text-navy text-balance">
          {heroDetails.heading}
        </h1>
